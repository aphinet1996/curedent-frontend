...
export const useAssistantStore = defineStore('assistant', () => {
  ...
  // แก้ไข: ใช้ UpdateAssistantRequest แทน Partial<CreateAssistantRequest>
  async function updateAssistant(id: string, assistantData: UpdateAssistantRequest | FormData): Promise<Assistant | null> {
    isLoading.value = true;
    error.value = null;
