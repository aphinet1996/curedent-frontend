...
export const appointmentService = {
     ...
     */
    async getCalendarDayAppointments(date: string): Promise<CalendarDayResponse> {
        return await authenticatedRequest<CalendarDayResponse>(`/appointments/calendar/day`, {
            method: 'GET',
            params: { date },
        });
    },
     ...
     */
    async getCalendarWeekAppointments(params: WeekViewParams): Promise<WeekViewResponse> {
        return await authenticatedRequest<WeekViewResponse>(`/appointments/calendar/week`, {
            method: 'GET',
            params,
        });
    },
     ...
     */
    async getCalendarMonthAppointments(params: MonthViewParams): Promise<MonthViewResponse> {
        return await authenticatedRequest<MonthViewResponse>(`/appointments/calendar/month`, {
            method: 'GET',
            params,
        });
    },
    ...
    async getAppointmentsByPatientId(patientId: string): Promise<ApiResponse<{
        ...
        return await authenticatedRequest<ApiResponse<{
            patientId: string;
            appointments: ApiAppointment[]
        }>>(`/appointments/patients/${patientId}`, {
            method: 'GET',
     ...
     */
    async createAppointment(appointmentData: CreateAppointmentRequest): Promise<ApiResponse<{ appointment: Appointment }>> {
        return await authenticatedRequest<ApiResponse<{ appointment: Appointment }>>('/appointments', {
            method: 'POST',
            body: appointmentData,
        });
    },
    ...
    async getAppointments(params?: {
        ...
        return await authenticatedRequest<ApiResponse<{ appointments: Appointment[] }>>('/appointments', {
            method: 'GET',
            params,
        });
    },
    ...
    async getUpcomingAppointments(params?: {
        ...
        return await authenticatedRequest<ApiResponse<{ appointments: ApiAppointment[] }>>('/appointments/upcoming', {
            method: 'GET',
            params,
        });
    },
     ...
     */
    async getAppointmentById(id: string): Promise<ApiResponse<{ appointment: Appointment }>> {
        return await authenticatedRequest<ApiResponse<{ appointment: Appointment }>>(`/appointments/${id}`, {
            method: 'GET',
        });
    },
     ...
     */
    async deleteAppointment(id: string): Promise<ApiResponse<null>> {
        return await authenticatedRequest<ApiResponse<null>>(`/appointments/${id}`, {
            method: 'DELETE',
        });
    },
     ...
     */
    async updateAppointmentStatus(id: string, status: string): Promise<ApiResponse<{ appointment: Appointment }>> {
        return await authenticatedRequest<ApiResponse<{ appointment: Appointment }>>(`/appointments/${id}/status`, {
            method: 'PATCH',
            body: { status },
        });
    }
