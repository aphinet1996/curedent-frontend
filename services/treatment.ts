...
export const treatmentService = {
  async getTreatments(params?: TreatmentParams): Promise<ApiResponse<{ treatments: Treatment[] }>> {
    return await authenticatedRequest<ApiResponse<{ treatments: Treatment[] }>>('/treatments', {
      method: 'GET',
      params,
    });
  },
  ...
  async getTreatmentById(id: string): Promise<ApiResponse<{ treatment: Treatment }>> {
    return await authenticatedRequest<ApiResponse<{ treatment: Treatment }>>(`/treatments/${id}`, {
      method: 'GET',
    });
  },
  ...
  async createTreatment(treatmentData: CreateTreatmentRequest): Promise<ApiResponse<{ treatment: Treatment }>> {
    ...
    return await authenticatedRequest<ApiResponse<{ treatment: Treatment }>>('/treatments', {
      method: 'POST',
      body: requestData,
    });
  },
  ...
  async deleteTreatment(id: string): Promise<ApiResponse<null>> {
    return await authenticatedRequest<ApiResponse<null>>(`/treatments/${id}`, {
      method: 'DELETE',
    });
  },
};